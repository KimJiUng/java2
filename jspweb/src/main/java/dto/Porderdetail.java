...
public class Porderdetail {
	...
	public Porderdetail(int orderdetailnum, int orderdetailactive, String scolor, String ssize, String pname,
			int pprice, float pdiscount, int samount, int totalprice, int ordernum) {
		super();
	...
	public String toString() {
		return "Porderdetail [orderdetailnum=" + orderdetailnum + ", orderdetailactive=" + orderdetailactive
