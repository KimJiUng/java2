...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<p style="font-weight: bold;">회원가입 및 정상적인 서비스 이용을 위해 아래 약관을 읽어보시고,<br> 동의 여부를 결정해 주세요.</p>
				<p>필수 약관을 동의 하셔야 회원가입이 가능합니다.</p>
				<div class="my-4" style="border-bottom: solid 1px #cccccc; border-top: solid 1px #cccccc; padding-top: 30px; ">
					<h3>회원가입 약관동의<span style="color: red;">*</span></h3>
					<textarea readonly rows="10" cols="" class="form-control" placeholder="
						제 1장 총칙
				...
				<div class="my-4">			
					...
					<textarea readonly rows="10" cols="" class="form-control" placeholder="가. 개인정보의 수집 및 이용 목적
