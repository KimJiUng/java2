...
<body>
	...
	<div class="container">	<!-- 본문 -->
		<h3 class="text-center">문의글쓰기</h3>
		<div class="titleline"></div> <br><br>
		<form action="boardlist.jsp" method="get">	<!-- 폼 양식 [입력값을 전송가능] -->
			<div class="row">
				<div class="col-md-3">
					작성자 : <input type="text" placeholder="작성자" class="form-control" maxlength="10">
				</div>
				<div class="col-md-3"> 
					비밀번호 : <input type="password" placeholder="비밀번호" class="form-control" maxlength="5">
				</div> 
			</div>
			<div class="row">
				<div class="col-md-8">
