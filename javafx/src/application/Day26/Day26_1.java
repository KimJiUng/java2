...
public class Day26_1 {
	...
	// TCP/IP
		...
		// IP : Internet Protocol address : 통신 인식 번호[주소-PC주소-집주소] : 0.0.0.0~255
	...
	public static void main(String[] args) {
		...
		// 3. 네이버회사의 ip 주소 확인
			...
			System.out.println("네이버 pc의 네트워크 객체 : "+inetAddress2);
		...
		// 4. 페이스북회사의 ip 주소 확인
			...
			System.out.println("페이스북 pc의 네트워크 객체 : "+inetAddress3);
